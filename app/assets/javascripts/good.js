...
function goodClick(e){
  var goodUserId = e.target.getAttribute('data-id')  
  var goodFlg = e.target.getAttribute('data-flg')   //どのdata-idがクリックされたかdata-idで判断する。
  // クリックされた場所がgoodアイコンなのか確認する
  if(goodFlg == "false" && goodUserId != null){
    var submitForm = e.currentTarget  //クリックされたフォームを取得する
